...
<head>
    ...
    <meta name="description" content="これはarchive_searchページです。">
    <title>archive_search page</title>
    ...
    <div class="l-container">
        <header class="l-header">
            ...
            <form class="p-search" action="#" method="get">
                <input type="text" class="p-search__text c-input u-bold" value="チーズバーガー">
                        ...
                        <li>
                            <figure class="p-card">
                                ...
                                <figcaption class="p-card__menu">
                                    <h2 class="c-heading--h2">見出しが入ります</h2>
                                    <h3>小見出しが入ります</h3>
